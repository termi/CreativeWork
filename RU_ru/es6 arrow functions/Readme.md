...
_Шаблоны деструктуризации мы не рассматриваются в рамках данной статьи - вы можете почитать про них в статье
...
(_метод `toMethod()` введён в es6 не рассматривается в рамках данной статьи_).
