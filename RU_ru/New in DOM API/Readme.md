...
Поддержка свойства **reversed** есть в Google Chrome. _Для остальных браузеров есть [Polyfill](https://github.com/termi/ES5-DOM-SHIM/blob/0.7/__SRC/a.js#L2570)._
